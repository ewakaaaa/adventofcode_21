...
def get_output_for_single_line(line):
    ...
    for digit in output:
        if len(digit) == 6 and len(digits[4].intersection(digit)) == 3 and len(digits[1].intersection(digit)) == 2: 
            output_value += '0'
        if len(digit) == 2: 
            output_value += '1'
        ...
        if len(digit) == 4:
            output_value += '4'
        if len(digit) == 5 and len(digits[4].intersection(digit)) == 3 and len(digits[1].intersection(digit)) == 1: 
            output_value += "5"
...
assert get_output_for_single_line(test_line) == 5353

puzzle_test_result = [] 
for line in puzzle_test:
    puzzle_test_result.append(get_output_for_single_line(line))
assert puzzle_test_result == [8394,9781,1197,9361,4873,8418,4548,1625,8717,4315]
